# [Bot](./README.md) &middot; [![GitHub license]](./LICENSE) ![Test Action]
...
```shell
git clone https://github.com/efiriyad/bot.git
```
...
[test action]: https://github.com/efiriyad/bot/actions/workflows/test.yaml/badge.svg
